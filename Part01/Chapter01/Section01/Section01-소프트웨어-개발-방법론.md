...
:small_blue_diamond: BI : 데이터를 활용하여 의사 결정 지원.
...
:small_blue_diamond: 카카오 서비스 이용자 관점에서의 플랫폼 : 카카오톡 등.
...
:small_blue_diamond: 표준 라이브러리 : 프로그래밍 언어에 내장.
